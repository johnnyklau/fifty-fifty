...
alter table public.games add column drawing_id uuid references public.drawings(id) on delete set null;
...
-- circle (used as generic seed)
insert into public.drawings (user_id, prompt_id, strokes) values (
  null,
